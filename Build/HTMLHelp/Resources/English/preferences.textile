...
* The @\T@ sequence is replaced by the current time, using the HH:MM:SS format and the 24-hour clock (for example, if it were 44 seconds after 3:30 in the afternoon then the sequence would be replaced with "15:30:44").
