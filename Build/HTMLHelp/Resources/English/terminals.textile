...
Use Window >> Show Command Line to display a floating window for
...
up-arrow key to automatically type recently-entered command
lines.  You can also use the mouse to access the history from the
window.
