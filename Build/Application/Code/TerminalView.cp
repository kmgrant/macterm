...
TerminalView_Init ()
{
	...
	// actual terminal font
	{
		...
		gASCIIToVT100GraphicsCharacterMap()['{'] = 'π'; ++mappingCount; // pi
						 ...
						 UInt32&					outPastEndOfRange)
{
	...
	else
	{
		...
		case kTerminalView_RangeCodeScrollRegionV:
			...
			// that is “not quite” as big as the largest possible height of the view
...
/*!
This method hides or shows the cursor “ghost”
					 ...
					 UInt16				inClickCount)													
{
	...
	SInt16				kNumberOfSpacesPerTab = 0; // zero means “do not substitute tabs”
