...
{
	kEventLoop_ControlEventClick						= FOUR_CHAR_CODE('√Ctl'),	//!< mouse is UP in a specific control in an active window
...
enum EventLoop_WindowEvent
{
	...
	kEventLoop_WindowEventScrolling						= FOUR_CHAR_CODE('SWin'),	//!< a device with scrolling capabilities such as a mouse’s
