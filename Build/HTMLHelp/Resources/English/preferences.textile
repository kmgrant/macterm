...
Suppresses the normal Full Screen mechanism of Mac OS X and uses
 a custom MacTerm scheme instead.

The OS X mode has advantages and disadvantages; it is generally
 ...
 The OS X method is more integrated with the system, allowing
