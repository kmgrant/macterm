...
use Open Transport natively...when will the next Òwave of the
futureÓ hit?).
...
threads for this allows MacTelnet to ÒblockÓ waiting
...
threadForDNS	(void*		inDNSThreadContextPtr)
{
	...
	// return the data indirectly by posting a new event to the main queue
	{
		...
		else
		{
			...
			// a lack of host info is the handlerÕs hint that there
