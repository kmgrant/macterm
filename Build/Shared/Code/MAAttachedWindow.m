...
//
//  Includes minor fixes to run on older Mac OS X versions, by Kevin Grant:
//  - Changed MAATTACHEDWINDOW_SCALE_FACTOR because it depends on the API
//    from NSScreen named "userSpaceScaleFactor" that is not only unavailable
//    in 10.3, but deprecated in 10.7.
//
...
#	define MAATTACHEDWINDOW_SCALE_FACTOR [[NSScreen mainScreen] userSpaceScaleFactor] // KMG
#else
#	define MAATTACHEDWINDOW_SCALE_FACTOR 1.0 // KMG - for 10.3
#endif
