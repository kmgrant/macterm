...
generate a MacTelnet print preview).  You cannot use line-by-line
printing yet.
...
well as mouse support.  MacTelnet implements a number of useful
...
rendering.  MacTelnet has a very good rendering of CP437, but
