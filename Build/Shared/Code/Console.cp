...
consoleÕs output.  This lets you organize printed
...
/*!
Signals the end of a function in the consoleÕs
...
string of the form "label = ÒvalueÓ" is written
...
string of the form "label = ÒtypeÓ" is written
to the console (with a new-line).
...
A string of the form "label = ÒvalueÓ" is written to
...
of the form "label = ÒvalueÓ" is written to the console
(with a new-line).
