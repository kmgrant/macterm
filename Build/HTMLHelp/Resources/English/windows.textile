...
* **Running:** The session has been open for awhile; MacTelnet will confirm when you try to close it.
...
Using Window >> IP Addresses of This Mac or the equivalent command
 from MacTelnet's Dock menu, you can display a floating window
