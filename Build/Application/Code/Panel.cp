...
active panels.  Do not assume how your panelÕs label
...
specified panelÕs handler, providing the handler
the given window.
...
specified panelÕs handler, and returns the panelÕs
response.
								 ...
								 Panel_DataSetTransition const&		inNewDataSet)
{
	if (nullptr != inRef)
	{
		...
		// ÒsupposedÓ to be changed by the callback; this ensures
...
effect identifies this panelÕs type.  Your descriptor
