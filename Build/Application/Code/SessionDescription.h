...
{
	kSessionDescription_ContentTypeCommand				= FOUR_CHAR_CODE('Shll'),	//!< represents local shell
	kSessionDescription_ContentTypeUnknown				= FOUR_CHAR_CODE('----')	//!< unknown contents, either because the
