...
The "Full Screen" command in the MacTerm application menu lets you
 focus entirely on the game.  Depending on the current setting of
 "Window Resize Effect", this may either change the font or the
 terminal size; hold down the Option key to temporarily do the
