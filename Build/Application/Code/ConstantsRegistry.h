...
enum
{
	...
	kFlagOS10_8API					= (kFlagManager_FirstValidFlag + 11),	//!< is Mac OS 10.8 or later in use?
	kFlagOS10_9API					= (kFlagManager_FirstValidFlag + 12),	//!< is Mac OS 10.9 or later in use?
