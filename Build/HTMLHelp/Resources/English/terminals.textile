...
for entering text locally.  Unlike typing directly into a terminal,
...
As a special exception, you can enter URLs (such as
http://www.apple.com/ or telnet://nowhere.loopback.edu/) into the
command line, and they are handled locally using your preferred
application.  Note that MacTelnet can handle some URLs itself.

The command line is somewhat shell-like, in that you can use the
up-arrow key to automatically type recently-entered command lines.
You can also use the mouse to access the history from the window.
...
this effect to create a dedicated terminal display (kiosk).
