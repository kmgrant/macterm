...
Enables the 16 colors commonly called "ANSI colors", which can
be customized in MacTelnet's Formats preferences.  This allows
an application to give text a specific foreground and background
color, instead of relying on terminal defaults.

For this to work, your Identity may need to be "xterm-color".
...
For this to work, your Identity may need to be "xterm".
...
|<. \1nn|<{padding-left:0.5em}. arbitrary ASCII in octal; e.g. "\177" is delete|
