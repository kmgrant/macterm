...
/*!
Locates and opens the font test picture file in the application
bundle, returning a new CGImage for it.  Use CFRelease() on the
image when finished.
...
{
	AppResources_Result		result = createImageFromBundleFile(CFSTR("FontTest200x32"), outPicture);
